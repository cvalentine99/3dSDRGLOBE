                ...
                return (
                  <button
                    ...
                    className={`w-full text-left p-3.5 rounded-xl border transition-all duration-200 group ${
                      isSelected
                        ? "bg-foreground/8 border-primary/30 glow-coral"
                        : "bg-foreground/3 border-border hover:bg-foreground/6 hover:border-border"
                    }`}
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex flex-col items-center gap-1.5 shrink-0 mt-0.5">
                        <a
                          ...
                          className="p-1 rounded-md hover:bg-foreground/30 transition-colors text-muted-foreground/50 hover:text-cyan-400"
                    ...
                    >
                      ...
                      <div className="px-4 pb-2">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          <span className="text-[9px] font-mono text-muted-foreground/50 uppercase">Tuning:</span>
                        ...
                        {milFreqs.map((freq) => {
                          ...
                          return (
                            <button
                              ...
                              className="w-full text-left px-2.5 py-2 rounded-lg hover:bg-foreground/5 transition-colors group"
                            >
                              <div className="flex items-center gap-2">
                                ...
                                {isExpanded ? (
                                  ...
                                  <ChevronRight className="w-3 h-3 text-muted-foreground group-hover:text-muted-foreground/70 shrink-0" />
                                )}
                              </div>

                              {/* Expanded details */}
                              {isExpanded && (
                                <div className="mt-2 p-2.5 rounded-lg bg-foreground/5 border border-border space-y-1.5">
...
function MiniDetail({ label, value }: { label: string; value: string }) {
  return (
    <div>
      <span className="text-[7px] font-mono text-muted-foreground/30 uppercase tracking-wider">{label}</span>
      <p className="text-[9px] text-foreground/70">{value}</p>
    </div>
  );
}
